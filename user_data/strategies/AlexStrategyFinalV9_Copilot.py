...
from freqtrade.exchange.exchange_utils import *  # noqa: F403
...
class AlexStrategyFinalV9_Copilot(IStrategy):
    """
    ...
    # Stoploss:
    stoploss = -0.1  # Were letting the model decide when to sell
    ...
    # Weights for calculating the aggregate score - the sum of all weighted
    # normalized indicators has to be 1!
    ...
    def set_freqai_targets(
        ...
        # Why? Normalizing the indicators will make them comparable and allow
        # us to assign weights to them.
        # How? We will calculate the z-score of each indicator by subtracting
        # the rolling mean and dividing by the rolling standard deviation.
        # This will give us a normalized value that is centered around 0 with a
        ...
        # Calculate the rolling mean and standard deviation of the trend
        # strength to determine a strong trend.
        # The threshold is set to 1.5 times the standard deviation above the
        # mean, but can be adjusted as needed.
        ...
        # EXPLANATION: If the price is above the upper Bollinger Band, assign
        # a value of 1 to R. If the price is below the lower Bollinger Band,
        # assign a value of -1 to R. Otherwise, the value R stays 0.
        # What's basically happening here is that we are assigning a value of 1
        # to R when the price is in the upper band, -1 when the price is in the
        # lower band, and 0 when the price is in the middle band. This is a
        # simple way to determine the market regime based on Bollinger Bands.
        # What is market regime? Market regime is the state of the market. It
        # can be trending, ranging, or reversing. So we are using Bollinger
        # Bands to determine the market regime. You can use other indicators
        # to determine the market regime as well. For example, you can use
        ...
        # EXPLANATION: Calculate the Bollinger Band width and assign it to V.
        # The Bollinger Band width is the difference between the upper and
        # lower Bollinger Bands divided by the middle Bollinger Band. The idea
        # is that when the Bollinger Bands are wide, the market is volatile,
        # and when the Bollinger Bands are narrow, the market is less volatile.
        # So we are using the Bollinger Band width as a measure of volatility.
        # You can use other indicators to measure volatility as well. For
        # example, you can use the ATR (Average True Range).
        ...
        dataframe["&-target"] = dataframe["T"].shift(-label_period_candles)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # One can define indicators here if needed and add logic to populate
        # entry_trend and populate_exit_trend.
        return dataframe
